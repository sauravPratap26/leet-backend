...
*/
-- CreateEnum
CREATE TYPE "Acceptance" AS ENUM ('ACCEPTED', 'REJECTED');

-- AlterTable
ALTER TABLE "Problem" ADD COLUMN "updatedAt" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
